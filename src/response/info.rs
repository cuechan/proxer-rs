...
//
//
// impl From<Value> for GetComments {
// 	fn from(serde_value: serde_json::Value) -> Self
// 	{
// 		let mut data = Vec::new();
//
// 		for comment in serde_value.as_array().unwrap() {
// 			data.push(Comment::from(comment.clone()));
// 		}
//
// 		Self { data: data }
// 	}
...
//
//
// impl Iterator for GetComments {
// 	type Item = Comment;
// 	fn next(&mut self) -> Option<Self::Item>
// 	{
// 		self.clone().data.into_iter().next()
// 	}
// }
